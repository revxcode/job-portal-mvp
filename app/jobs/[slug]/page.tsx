  ...
  return (
    <main className="min-h-screen bg-gray-50 py-8">
      ...
      <div className="container mx-auto px-4 max-w-4xl">
        ...
        <Link href="/" className="text-gray-500 hover:text-gray-700 text-sm mb-8 inline-block font-medium transition-colors">
          ← Kembali ke Lowongan
        </Link>
        ...
        <div className="bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm hover:shadow-md transition-shadow duration-300">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0">
            ...
            <div className="md:col-span-2 p-8 border-r border-gray-100">
              <h2 className="text-base font-semibold text-gray-900 mb-4 uppercase tracking-wide">Deskripsi Pekerjaan</h2>
